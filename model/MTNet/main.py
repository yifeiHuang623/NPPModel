...
def train_model(model: MTNet, train_dataloader: DataLoader, valid_dataloader: DataLoader, metric_keys, args):
    ...
    lr_scheduler = torch.optim.lr_scheduler.StepLR(opt, step_size=args.lr_step_size, gamma=args.lr_gamma)
...
def train(dataloader: dict[DataLoader], dataset_name, **kv):
    ...
    with open('./model/MTNet/MTNet.yaml', 'r', encoding='utf-8') as f:
