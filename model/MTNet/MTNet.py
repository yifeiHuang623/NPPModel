...
class MTNet(nn.Module):
    def __init__(self, args) -> None:
        ...
        self.TreeLSTM_model = TreeLSTM(h_size=args.h_size, nary=args.n_time_slot + 1,
                              ...
                              num_cats=num_poi_cats, cat_embed_dim=args.cat_embed_dim,
                              num_coos=num_regions, coo_embed_dim=args.coo_embed_dim,
    ...
    def get_MT_input(self, batch_data, test: bool=False):
        ...
        for trajectory, labels in zip(trajectories_list, labels_list):
            mobility_tree = construct_MobilityTree(trajectory, labels,self.n_time_slot + 1)
