...
@register_dataloader(name="gowalla_time_interval")
class gowalla_TimeInterval_DataLoader(BaseDataLoader):
    def __init__(self, model_args=None, pre_views=None, post_views=None) -> None:
        super().__init__(
            MyDataset=MyDatasetTimeInterval,
            dataset_name="gowalla_time_interval",
            logger=logger,
            args=args,
...
@register_dataloader(name="gowalla_fixed_length")
class gowalla_FixedLength_DataLoader(BaseDataLoader):
    def __init__(self, model_args=None, pre_views=None, post_views=None) -> None:
        super().__init__(
            MyDataset=MyDatasetFixedLength,
            dataset_name="gowalla_fixed_length",
            logger=logger,
            args=args,
            model_args=model_args or {},
            pre_views=pre_views,
...
@register_dataloader(name="gowalla_recent_k")
class gowalla_Recent_DataLoader(BaseDataLoader):
    def __init__(self, model_args=None, pre_views=None, post_views=None) -> None:
        super().__init__(
            MyDataset=MyDatasetRecentK,
            dataset_name="gowalla_recent_k",
            logger=logger,
            args=args,
            model_args=model_args or {},
            pre_views=pre_views,
...
if __name__ == "__main__":
    d = gowalla_TimeInterval_DataLoader(model_args={"batch_size": 32})
